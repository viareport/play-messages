...
public abstract class MessagesResource {
    ...
    public static String DEFAULT_CONTROLLER = "default";
     ...
     */
    public abstract Map<String,String> loadMessages(String language, String controller);


    /**
     * Saves new value for given key.
     */
    public abstract void save(String language, String controller, String key, String value);
     ...
     * Removes given keys.
     */
    public abstract void removeAll(String language, String controller, List<String> keys);
