...
public class SourceKeys {
    ...
    public static SourceKeys lookUp(String controller) {
            ...
            while (iterator.hasNext()) {
                try {
                    ...
                    if (StringUtils.isBlank(controller) || 
                    		MessagesResource.DEFAULT_CONTROLLER.equalsIgnoreCase(controller) ||
                    		StringUtils.containsIgnoreCase(file.getAbsolutePath(), controller.substring(0, controller.length() - 2))) {
