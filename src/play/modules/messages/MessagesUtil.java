...
public class MessagesUtil {
	...
	public static String[] getApplicationControllers() {
		String[] controllerClasses = new File(new File(Play.applicationPath, "app"), "controllers").list();
        for (int i=0 ; i<controllerClasses.length ; i++) {
        	controllerClasses[i] = controllerClasses[i].substring(0, controllerClasses[i].lastIndexOf('.'));
        }
